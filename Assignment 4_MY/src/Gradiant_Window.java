...
public class Gradiant_Window extends Button {
    private final Button topBar;
    private final Button closeButton;
    private boolean visible;
    private static Gradiant_Window instance;
    

   //singleton pattern for window
    public static Gradiant_Window getInstance(int x, int y, int width, int height, String text) {
        if (instance == null) {
            instance = new Gradiant_Window(x, y, width, height, text);
        }
        return instance;
    }

    private Gradiant_Window(int x, int y, int width, int height, String text) {
